...
def calcular_calorias(opera):
  ...
  if opera == 1:
    resul = (tiempo_actividad*2*peso/200)
  elif opera == 2:
    resul = (tiempo_actividad*5*peso/200)
  elif opera == 3:
    resul = (tiempo_actividad*14*peso/200)
  elif opera == 4:
    resul = (tiempo_actividad*6*peso/200)
  elif opera == 5:
    resul = (tiempo_actividad*9.8*peso/200)
  return resul
